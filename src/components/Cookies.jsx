        ...
        <div className="modal-dialog  modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <p>Si tienes alguna pregunta sobre esta política de privacidad, contáctanos a <a href="mailto:todoarte@gmail.com" title='Enviar Correo'>todoarteeee@gmail.com</a>.</p>
            </div>
